...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<RedstoneReceiverEntity> RECEIVER_BE = Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Redstone_frequencies.MOD_ID, "receiver_be"), FabricBlockEntityTypeBuilder.create(RedstoneReceiverEntity::new, ModBlocks.REDSTONE_RECEIVER).build());
